...
class AliceEHOKProgram(Program):
    ...
    def run(self, context: ProgramContext) -> Generator[EventExpression, None, Dict[str, Any]]:
        """
        Execute Alice's protocol.
        """
        logger.info("Alice started E-HOK protocol")
        ...
        logger.info(f"Alice finished. Generated {len(self.measurement_buffer)} records.")
